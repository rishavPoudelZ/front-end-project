  ...
  return (
    <>
      <div className="bg-cover bg-center h-screen" style={{ backgroundImage: 'url("src/assets/LandingImage.webp")'}}>
        ...
        <div className="relative isolate px-6 pt-56 md:pt-26 lg:px-8 lg:pt-1">
          <div
      ...
      <div className="backgroundRed">
        <div className="mx-auto max-w-2xl px-0 py-2 sm:px-0 sm:py-4 lg:max-w-screen-2xl lg:px-4">
          <h2 className="sr-only">Products</h2>

          <div className="grid grid-cols-1 gap-y-1 gap-x-6 sm:grid-cols-2 sm:gap-y-2 lg:grid-cols-2 xl:grid-cols-2 xl:gap-x-2">
